...
function printHelp ()
{
    ...
    echo -e "${GREEN}-n ${RESET}defaults to ${GREEN}dotboxblockchain-network${RESET}. use ${YELLOW}-n your-named-network ${RESET}if you are using a different network name"  | indent
...
NETWORK_NAME="dotboxblockchain-network"
...
# V0.14
composer-rest-server -c admin@dotboxblockchain-network
